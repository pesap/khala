...
Write a short 3–4 line summary of the change, why it is needed, and any review
context.

## Acceptance criteria

List every acceptance criterion from the source issue as a checkbox. Check only
...
- Explain any unmet criteria, intentional deviations, or follow-up work. Use
  `None.` when there are no deviations.
