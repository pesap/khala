...
description:
  Apply NASA/JPL Power of Ten style constraints to audit and harden code for
  predictability, simplicity, and explicit error handling. Use this skill when
  users ask for strict code quality, safety-oriented cleanup, anti-slop
  refactors, or NASA-style standards, even if they only ask to "clean up" or
...
- User asks for NASA guidelines, JPL Power of Ten, or safety-critical coding
  discipline.
- User wants stricter quality gates for complexity, error handling, and
  determinism.
...
2. Map NASA/JPL rules to project language.
   - Evaluate applicability for each principle; do not force C-specific wording
     onto unrelated languages.
