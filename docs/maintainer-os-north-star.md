...
itself. The launched worker owns the empty-commit draft PR, implementation edits
inside the worktree, Reviewer Two loop, and PR/CI updates while the five-minute
heartbeat feeds trusted comments and failing checks back into the worker pane.
