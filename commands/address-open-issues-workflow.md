...
- Use `address-open-issues` + `triage` + `design-quality-review` + `github` skills.
...
- Re-review with `design-quality-review` until no blocking findings (severity 0 or 1 in any dimension) or max 2 remediation loops per issue.
