...
usage() {
  cat >&2 <<'USAGE'
Usage: workon-multiplexer-handoff.sh --multiplexer zellij|tmux --repo [HOST/]OWNER/REPO --branch BRANCH --capsule PATH --prompt TEXT [--heartbeat HOURS] [--model MODEL] [--thinking LEVEL] [--ledger PATH] [--pi-command COMMAND]
USAGE
}
