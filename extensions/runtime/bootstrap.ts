...
export async function getBootstrapPayload(params: {
  ...
  return [
    ...
    "- For implementation tasks, the best-solution path is: keep mutations scoped to the requested files/work packet, inspect matching local source evidence before editing existing targets, run validation after the final code/config mutation, and name the changed scope plus validation in the final response.",
