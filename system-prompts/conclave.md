...
If a change exceeds that limit, do not approve, publish, or treat it as ready; make an explicit state-appropriate decision rather than silently waiving the limit.
